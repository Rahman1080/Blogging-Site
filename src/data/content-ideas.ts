...
export const contentIdeas: IdeaSection[] = [
  ...
  },
  {
    ...
    ideas: [
      ...
      {
        topic: "Android battery draining fast after an update (why and how to fix it)",
        category: "Android",
        why: "After every major Android update, the same problem-focused query spikes: battery life drops or drains fast. Most coverage is fear-driven news; a calm, step-by-step fix guide with realistic expectations (background re-optimization vs. real problems) fills a genuine gap.",
        score: 71,
        searchQuestions: [
          "battery draining after android update",
          "android update battery drain fix",
          "why is my battery draining so fast after update",
        ],
        gap: "Top results mix news hype with generic tips; few explain the normal re-optimization window versus actual bugs.",
        intent: "Troubleshooting",
        signals: [
          { label: "Search demand", strength: "high", note: "Spikes after every major Android release; recurring, not one-off." },
          { label: "Competition quality", strength: "high", note: "Coverage is scattered between news and forums; no definitive evergreen guide." },
          { label: "Site fit", strength: "high", note: "Directly extends extend-android-battery-life and android-phone-running-slow." },
        ],
        relatedKeywords: ["android update battery drain", "battery draining fast android"],
        longTail: ["why is battery draining after android update", "android 15 battery drain fix"],
        relatedQuestions: ["Is battery drain after an update normal?", "How long does battery re-optimization take after an update?"],
      },
      {
        topic: "Wi-Fi connected but no internet on Windows (fix it in order)",
        category: "Internet",
        why: "One of the most common troubleshooting queries on Windows. Existing results are jumbled lists; an ordered, most-likely-first guide that rules out DNS, IP, and network-driver causes wins.",
        score: 75,
        searchQuestions: [
          "wifi connected but no internet windows",
          "connected to wifi but no internet",
          "wifi no internet access windows 11",
        ],
        gap: "Answers are unordered, often contradictory; a decision-tree-style fix sequence is rare.",
        intent: "Troubleshooting",
        signals: [
          { label: "Search demand", strength: "high", note: "Extremely common, recurring query across Windows 10/11." },
          { label: "Competition quality", strength: "high", note: "Mostly forum threads and listicles; a clean ordered guide can stand out." },
          { label: "Site fit", strength: "high", note: "Complements wifi-not-working-fixes and speed-up-windows-11-pc." },
        ],
        relatedKeywords: ["wifi connected but no internet", "no internet access but connected"],
        longTail: ["wifi connected but no internet windows 11", "ethernet no internet but wifi works"],
        relatedQuestions: ["Why is my Wi-Fi connected but there is no internet?", "How do I fix DNS errors on Windows?"],
      },
      {
        topic: "iPhone storage still full after deleting photos (what's really using it)",
        category: "iPhone",
        why: "Users delete photos expecting space back, then find storage barely changed. A guide explaining 'Recently Deleted', iCloud offloading, and the real space hogs (apps, system data, Messages) is genuinely useful.",
        score: 72,
        searchQuestions: [
          "iphone storage full after deleting photos",
          "iphone storage not going down after deleting photos",
          "why is iphone storage still full",
        ],
        gap: "Vendor pages are shallow; most forum answers cover one cause. A structured breakdown of every space consumer is missing.",
        intent: "Troubleshooting",
        signals: [
          { label: "Search demand", strength: "high", note: "Persistent, high-frustration query across iOS versions." },
          { label: "Competition quality", strength: "high", note: "Shallow coverage that misses the Recently Deleted and iCloud nuances." },
          { label: "Site fit", strength: "high", note: "Extends free-up-storage-phone and backup-iphone-guide." },
        ],
        relatedKeywords: ["iphone storage not decreasing", "iphone other storage too high"],
        longTail: ["why is my iphone storage full after deleting photos", "how to clear other storage on iphone"],
        relatedQuestions: ["Why doesn't iPhone storage go down when I delete photos?", "What is 'Other' storage on iPhone?"],
      },
      {
        topic: "How to identify an AI scam message (text, email, and voice)",
        category: "Cybersecurity",
        why: "Generic 'be careful' advice is everywhere, but people need concrete red flags to spot an AI-written or AI-cloned message before they click. A practical, example-driven guide turns awareness into action.",
        score: 68,
        searchQuestions: [
          "how to identify an ai scam message",
          "ai scam text message red flags",
          "how to tell if a message is ai generated scam",
        ],
        gap: "Coverage is either newsy or too vague; few guides give concrete examples of what AI scam texts and emails look like.",
        intent: "How-to",
        signals: [
          { label: "Search demand", strength: "medium", note: "Growing alongside AI-assisted scam campaigns and carrier/FTC warnings." },
          { label: "Competition quality", strength: "high", note: "Few concrete, example-led identification guides." },
          { label: "Site fit", strength: "high", note: "Builds on ai-scams-deepfake-calls; fits cybersecurity category." },
        ],
        relatedKeywords: ["ai scam message", "ai phishing red flags", "spot ai text scam"],
        longTail: ["what does an ai scam text look like", "ai scam email red flags"],
        relatedQuestions: ["What are the signs of an AI scam message?", "How do scammers use AI in phishing?"],
      },
    ],
  },
  {
